...
public class CustomAccessDeniedHandler implements AccessDeniedHandler {
    ...
    public void handle(
        ...
        String detailMessage = accessDeniedException.getMessage() != null ? accessDeniedException.getMessage() : "You do not have permission to access this resource.";
        ...
        problem.put("detail", detailMessage);
        problem.put("instance", request.getRequestURI());
        problem.put("errorCode", "AUTH_ACCESS_DENIED");
        problem.put("timestamp", Instant.now().toString());
        problem.put("error", "FORBIDDEN");
        problem.put("message", detailMessage);
